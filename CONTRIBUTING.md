...
To report a bug, first make sure there isn't already an open [GitHub Issue](https://github.com/WhiteSymmetry/spacecurves/issues)
...
* The spacecurves version you are using.
* Detailed steps to reproduce the bug.
* A tag, if appropriate (_e.g._, "bug" or "enhancement").

### Fix Open Issues

Look through the [GitHub Issues](https://github.com/WhiteSymmetry/spacecurves/issues) for any
...
2. Create your own fork of the spacecurves [repository](https://github.com/WhiteSymmetry/spacecurves).
3. Clone your repository, for example by typing in your terminal:
`git clone https://github.com/<your_username>/spacecurves.git`.
4. Install `spacecurves` as editable in your new environment:
...
Please note that the spacecurves project is released with a
